# Django settings for teamk_project project.
...
SECRET_KEY = 'd(dxzb=qexk*iq(%k+$871ga)h3xs9ql&b)xkc)6kl^tek^#g)'
...
ROOT_URLCONF = 'teamk_project.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'teamk_project.wsgi.application'
