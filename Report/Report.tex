...
{
\begin{figure}[h]
\center{\caption{An Entity-Relationship diagram displaying the relation between Groups, Events, Sessions and Subsessions}}
\centering
...
The final version of our application has the following features implemented:
\begin{itemize}
